...
| File | Step |
|------|------|
| `Screenshot_2026-05-22_at_10.42.38_AM-*.png` | Login / welcome |
| `Screenshot_2026-05-22_at_10.41.17_AM-*.png` | Tour step 1 (intro) |
| `Screenshot_2026-05-22_at_10.41.37_AM-*.png` | Tour step 2 (product preview) |

**Tour step order (first run):** product steps → **second-to-last: Founder API Key** → **last: Project name + create**.

Canonical flow is defined in `CONTEXT.md` (**Feature tour**, **Conversational onboarding**).
